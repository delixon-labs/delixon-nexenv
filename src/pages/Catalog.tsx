    ...
    <div className="p-6 lg:p-8 h-full overflow-y-auto">
      ...
      <div className="mb-4">
        <input
          ...
          className="w-full max-w-md px-4 py-2 rounded-lg bg-gray-900 border border-gray-800 text-white placeholder-gray-600 text-sm focus:outline-hidden focus:border-primary-500/50"
        />
      </div>
